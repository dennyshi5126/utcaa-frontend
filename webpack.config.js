...
module.exports = {
  mode: 'development',
  entry: ['webpack-dev-server/client?http://0.0.0.0:3000', 'webpack/hot/only-dev-server', './app/app.js'],
  output: {
  ...
  plugins: [new MiniCssExtractPlugin('[name].css'), devFlagPlugin, new webpack.NoEmitOnErrorsPlugin()],
};
